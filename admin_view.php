...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin') {
    echo "<script>alert('Access Denied! Your role is: " . $_SESSION['role'] . "'); window.location='login.php';</script>";
    exit();
}

// FIXED: Use your actual table structure (no 'id' column)
...
<head>
    ...
    <style>
        ...
        /* Custom table-blue with column lines */
        .table-blue {
...
<nav class="navbar navbar-expand">
    <div class="container">
        ...
        <div class="navbar-nav ms-auto">
            <a href="dashboard.php" class="nav-link me-3 btn btn-primary">Dashboard</a>
        ...
        <div class="table-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="user-count">
                    <?php echo mysqli_num_rows($result); ?> Users
                </span>
            </div>
        </div>
